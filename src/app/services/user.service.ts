  ...
  public users = [
    ...
    },
    {
      ...
      layout: [
        ...
        { id: 'a1', cols: 3, rows: 4, y: 0, x: 0, title: 'James item A1', gridtype: 'barChart', gridData: 'barChart' },
        { id: 'a2', cols: 3, rows: 4, y: 0, x: 3, title: 'James item A2', gridtype: 'doughnut', gridData: 'doughnut' },
        { id: 'a3', cols: 3, rows: 4, y: 0, x: 3, title: 'James item A3', gridtype: 'iframe', gridData: '' }]
    },
    {
      username: 'smith',
      password: 'smith',
      layout: [
        ...
        { id: 'a1', cols: 2, rows: 1, y: 0, x: 0, title: 'Smith item A1', gridtype: 'powerChart', gridData: 'barChart' }]
